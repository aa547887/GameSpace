...
namespace GameSpace.Areas.MiniGame.Models
{
    ...
    {
        public PaginatedResult<GameSpace.Models.Coupon> Coupons { get; set; } = new PaginatedResult<GameSpace.Models.Coupon>();
        public List<GameSpace.Models.User> Users { get; set; } = new List<GameSpace.Models.User>();
        public string SearchTerm { get; set; } = string.Empty;
        public int Page { get; set; } = 1;
        public int PageSize { get; set; } = 10;
    ...
    {
        public PaginatedResult<Evoucher> EVouchers { get; set; } = new PaginatedResult<Evoucher>();
        public List<GameSpace.Models.User> Users { get; set; } = new List<GameSpace.Models.User>();
        public string SearchTerm { get; set; } = string.Empty;
        public int Page { get; set; } = 1;
        public int PageSize { get; set; } = 10;
