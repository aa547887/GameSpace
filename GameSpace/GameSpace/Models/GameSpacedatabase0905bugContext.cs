...
public partial class GameSpacedatabase0905bugContext : DbContext
{
    public GameSpacedatabase0905bugContext(DbContextOptions<GameSpacedatabase0905bugContext> options)
        : base(options)
    {
    }
