...
namespace GamiPort.Areas.Login.Controllers
{
    ...
    public class UserIntroducesController : Controller
    {
        ...
        // GET: Login/UserIntroduces
        public async Task<IActionResult> Index()
        {
            var gameSpacedatabaseContext = _context.UserIntroduces.Include(u => u.User);
            return View(await gameSpacedatabaseContext.ToListAsync());
        }

        // GET: Login/UserIntroduces/Details/5
        ...
        // GET: Login/UserIntroduces/Create
        ...
        // POST: Login/UserIntroduces/Create
        ...
        // GET: Login/UserIntroduces/Edit/5
        ...
        // POST: Login/UserIntroduces/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: Login/UserIntroduces/Delete/5
        ...
        // POST: Login/UserIntroduces/Delete/5
